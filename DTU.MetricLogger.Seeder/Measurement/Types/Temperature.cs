namespace DTU.MetricLogger.Seeder.Measurement.Types
{
    public class Temperature : IMeasure
    {
        ...
        readonly double _minValue = -45.0;
        readonly double _maxValue = 55.0;
        ...
        public Temperature(Guid device)
        {
            _device = device;
        }
        ...
        public double GetValue()
        {
            ...
            //Return a new random reading allowed to gap with this.Span in both ends
